...
from levelupapi.models import Game, Event, Gamer, Event_Gamer
    ...
    def signup(self, request, pk=None):
        ...
        if request.method == "POST":
            ...
            try:
                ...
                registration = Event_Gamer.objects.get(
...
class EventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Event
        fields = ('id', 'event_time', 'game','gamer', 'location', 'joined')
